...
//             'x-rapidapi-key': '2a88e01c46mshf53694137642789p1e6e36jsn58a9a64a8d56'
//         }
//     });
//     resp.then((res) =>{
//         const pr2 = res.json();
...
const showUI = (list) =>{
    list.forEach((obj,idx) =>{
        ...
        newCard.innerHTML = `
            <img src='${obj.videoThumbnails[0].url}'>
            <h6 class="author">${obj.author}</h6>
...
const handleSearch = (e) =>{
    ...
    root.innerHTML = "";
    var list = dummyData.filter((elem) => {
        const curr = elem.title.toLowerCase();
        const curra = elem.author.toLowerCase();
        if(curr.search(tmp) != -1 || curra.search(tmp) != -1) return true;
        return false;
    });
    showUI(list);
};